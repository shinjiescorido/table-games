...
const cards = {
		...
		'0009': { suite : 'club', value : 10, bcValue: 0},
		'0010': { suite : 'club', value : 11, bcValue: 0},
		'0011': { suite : 'club', value : 12, bcValue: 0},
		'0012': { suite : 'club', value : 13, bcValue: 0},
		// hearts
		...
		'0022': { suite : 'heart', value : 10, bcValue: 0},
		'0023': { suite : 'heart', value : 11, bcValue: 0},
		'0024': { suite : 'heart', value : 12, bcValue: 0},
		'0025': { suite : 'heart', value : 13, bcValue: 0},
		// diamonds
		...
		'0035': { suite : 'diamond', value : 10, bcValue: 0},
		'0036': { suite : 'diamond', value : 11, bcValue: 0},
		'0037': { suite : 'diamond', value : 12, bcValue: 0},
		'0038': { suite : 'diamond', value : 13, bcValue: 0},
		// spades
		...
		'0048': { suite : 'spade', value : 10, bcValue: 0},
		'0049': { suite : 'spade', value : 11, bcValue: 0},
		'0050': { suite : 'spade', value : 12, bcValue: 0},
		'0051': { suite : 'spade', value : 13, bcValue: 0}
};
...
function getBCVal(value) {
	if(isCard(value)) {
		return cards[value].bcValue === undefined ? cards[value].value : 0;
	}
}
